...
<?php $__env->startSection('title', 'Book Return'); ?>
    ...
    <form action="book-return" method="post">
        ...
        <div class="mb-3">
            ...
            <select name="book_id" id="book" class="form-control inputbox">
                ...
                <option value="<?php echo e($item->id); ?>"> <?php echo e($item->book_code); ?> <?php echo e($item->title); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
        </div>
        <div>
...
<?php echo $__env->make('layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\book_rent\resources\views/return-book.blade.php ENDPATH**/ ?>